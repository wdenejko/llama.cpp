...
for _v in GGML_TOPK_LOG GGML_VK_EVENT_DEVICE_WAIT GGML_VK_EVENT_TL_OFF GGML_VK_DISABLE_FUSION GGML_VK_PERF_LOGGER GGML_VK_DENSE_F16B GGML_VK_DENSE_WAVE32 RADV_PERFTEST \
             GGML_VK_MMID_INT GGML_VK_MMID_F16B GGML_VK_MMID_SCALE_EPILOGUE GGML_VK_MMID_PROBE GGML_VK_MMID_COMPACT GGML_VK_DENSE_THIN_BM GGML_VK_MMID_BN48 GGML_VK_MM_TILE_EPILOG GGML_VK_DENSE_BM256 Q4X_SPEC_STOCH_TOPK Q4X_SPEC_STOCH_TEMP; do
