...
for _v in GGML_TOPK_LOG GGML_VK_EVENT_DEVICE_WAIT GGML_VK_EVENT_TL_OFF GGML_VK_DISABLE_FUSION GGML_VK_PERF_LOGGER Q4X_SPEC_STOCH_TOPK Q4X_SPEC_STOCH_TEMP; do
