...
void ggml_compute_forward_q4x_hc_combine(const struct ggml_compute_params * params, struct ggml_tensor * dst);
void ggml_compute_forward_q4x_qsa_union(const struct ggml_compute_params * params, struct ggml_tensor * dst);
void ggml_compute_forward_q4x_qsa_mask_gather(const struct ggml_compute_params * params, struct ggml_tensor * dst);
void ggml_compute_forward_q4x_qsa_kv_gather(const struct ggml_compute_params * params, struct ggml_tensor * dst);
void ggml_compute_forward_q4x_hc_mix_collapse(const struct ggml_compute_params * params, struct ggml_tensor * dst);
